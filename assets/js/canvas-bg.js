...
class ParticleBackground {
    ...
    getThemeSettings() {
        ...
        return {
            // Light: subtle greyish (#71717a), Dark: gentle off-white (#e4e4e7)
            rgb: isLight ? '113, 113, 122' : '228, 228, 231',
            particleOpacity: isLight ? 0.22 : 0.12,
            lineOpacity: isLight ? 0.18 : 0.10,
